...
class Documento{
	...
	public static function validarCPF($cpf):bool{
		...
		// Verifica se um númnero foi informado
		if(empty($cpf)) {
        return false;
    }
    ...
    // Verifica se a o numero de digitos informados é igual a 11
    if (strlen($cpf) != 11) {
        echo "length";
        return false;
    }
...
/*
$cpf = new Documento();
$cpf->setNumero("46392591826");

var_dump($cpf->getNumero());
*/

var_dump(Documento::validarCPF("46392591826"))
